...
class QueryParam:
    ...
    """If set, only return entities/relations/chunks whose source_id overlaps this set.
    Used for document-level tag filtering within a shared workspace without re-ingestion.
    """
